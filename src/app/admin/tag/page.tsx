...
import { CreateTagModal, UpdateTagModal } from "@/app/admin/tag/components";
...
const handleDelete = async (row: API.DeleteRequest) => {
  ...
  if (!row) return true;
  try {
    const res: any = await deleteTagUsingPost({
      id: row.id,
    });
    ...
    <>
      <ProTable<API.TagVO>
        ...
        request={async (params, sort, filter) => {
          ...
          const { data, code }: any = await listTagByPageUsingPost({
            ...params,
            ...filter,
            sortField,
            sortOrder,
